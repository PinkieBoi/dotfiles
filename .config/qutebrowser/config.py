...
## QtWebEngine: project: https://wiki.qt.io/QtWebEngine 
## QtWebKit official fork: https://github.com/qtwebkit/qtwebkit
## Type: String
## Valid values: webengine (recommended) or webkit
c.backend = 'webengine'
...
## Color gradient interpolation system for download
## Type: ColorSystem
## Valid values:
...
c.completion.height = '30%'     # Type: PercOrInt
...
c.completion.quick = True     # Type: Bool
...
c.content.desktop_capture = False   # Type: BoolAsk
...
## User agent to send (FormatString)
...
## Website permissions
c.content.media.audio_capture = 'ask'       # Type: BoolAsk
c.content.media.audio_video_capture = 'ask' # Type: BoolAsk
c.content.media.video_capture = 'ask'       # Type: BoolAsk
c.content.mouse_lock = False                # Type: BoolAsk
...
c.content.register_protocol_handler = 'ask'         # Type: BoolAsk
...
c.content.site_specific_quirks.skip = ['ua-whatsapp', 'js-whatsapp-web', 'js-string-replaceall']
...
## Enter insert mode insert rules
